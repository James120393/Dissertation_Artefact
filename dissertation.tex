...
\begin{figure}
	\centering
	\includegraphics[width=0.5\textwidth]{STMResults}
	\caption{The HTML results table produced by the StarCraft Tournament Manager.}
	\label{Fig3}
\end{figure}

TALK ABOUT THE LIFECYCLE OF THE ARTEFACT AGILE TEST DRIVEN DEVELOPMENT TTD
NO USE OF DAILY SCRUMS.

During the production of the research artefact an iterative development process was employed. this involved laying out a design for the AI and software required and producing a working prototype by the end of the first sprint. Then adding to that prototype each sprint until the AI was completed to a degree of satisfaction.

\subsection{Sprint 1 : Software Installation}
CODE RUNS BUT NOT FOR PROTOSS
...
\end{itemize}
These questions were rejected due to time limitations on creating an adaptive AI.
\newline
