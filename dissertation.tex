...
During testing there was a total of 10 AI's including the AI that was developed for this research, for the rest of this paper will be refereed to as POSH-bot. To choose these AI's, three were selected from the top of the board, three from the middle and three from the bottom. They will be selected from the AIIDE 2016 competition, to keep the experiment af fair as possible each AI in each tier will consist of each of the races, where that is not possible, a substitute will be made \cite{2016}. AIIDE 2016 was chosen as all the AI's required for testing were available for download.
...
\section{Results}
After the implementation of the three chosen strategies, and final testing stages within the tournament manager, the results contained within table 6 located in the appendix came forth. From the other tables were produced, table 1 and 2 were produced automatically by the STM, table 3 and 4 were manually created. 
...
Surviving rush
From the results in table 3, under the average game length, the shortest games were against the Protoss, this was not unexpected as during development mirror matches proved the most difficult to win. Though the Protoss 

score

comparison against different races

comparison against top bots
\begin{figure}[H]
	\centering
